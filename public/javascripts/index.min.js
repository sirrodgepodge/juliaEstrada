        ...
        addresses.forEach(function(val, index) {
            $.getJSON("//maps.googleapis.com/maps/api/geocode/json?address=" + val, null, function(data) {
                ...
                google.maps.event.addListener(marker, "click", function() {
                    infowindow.open(map, marker), map.panTo(marker.getPosition());
...
var main = function() {
    $landingTogglers.click(function() {
        ...
        } else $landingHead.addClass("fade-out"), $(this).toggleClass("landing-active"), 
...
}, titleTop = Math.ceil($landing.outerHeight()), landingHeadFixPoint = titleTop - Math.ceil($landingHead.offset().top), contactTop = .92 * Math.ceil($contact.offset().top), downAnimReached = .395 * titleTop + 4.5, listeners = function() {
    var pagePos = 0, titleFixed = !1, landingHeadFixed = !1, topTextShowing = !0, contactPopped = !1, landingScroll = function() {
        pagePos = window.pageYOffset, (pagePos >= landingHeadFixPoint && !landingHeadFixed || landingHeadFixPoint > pagePos && landingHeadFixed) && ($landingHead.toggleClass("hide"), 
    ...
    landingScroll(), $(window).resize(function() {
        titleTop = Math.ceil($landing.outerHeight()), landingHeadTop = titleTop - Math.ceil($landingHead.offset().top), 
