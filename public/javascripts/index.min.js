...
function initBufferVideo(iframe) {
    playVideo(iframe), setTimeout(stopVideo(iframe), 200);
}
...
function calcTriggerPoints() {
    ...
    downAnimReached = .395 * titleTop + 4.5, photosSectTop = .82 * Math.ceil($photosSect.offset().top), 
    landingScroll();
}
...
$window.scrollTop(0), $.get("/api/info", function(data) {
    contact = data.contact;
});

var landingTogglerClicked = !1, main = function() {
    if (window.scrollTo(0, 0), $scrollTo.click(function() {
